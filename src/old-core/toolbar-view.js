...
export default class ToolbarView {
  ...
  createLayout() {
    ...
    const newFile = createElement('a', 'fbv-toolbar-item fbv-text');
    const newDir = createElement('a', 'fbv-toolbar-item fbv-text');
    const rename = createElement('a', 'fbv-toolbar-item fbv-text');
    const remove = createElement('a', 'fbv-toolbar-item fbv-text');
